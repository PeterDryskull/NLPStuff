...
class FFNN(nn.Module):
    ...
    def forward(self, input_vector):
        ...
        hidden = self.activation(hidden)  # Apply ReLU activation function
...
if __name__ == "__main__":
    ...
    for epoch in range(args.epochs):
        ...
        print(f"Training time for this epoch: {time.time() - start_time:.2f}s")
        ...
        print(f"Validation time for this epoch: {time.time() - start_time:.2f}s")
